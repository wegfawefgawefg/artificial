...
register_item{ name = "Bandage", type = 100, category = 1, max_count = 5, consume_on_use = true, sprite = "bandage", desc = "+25 HP",
  on_use = function() api.heal(25) end }
register_item{ name = "Health Kit", type = 101, category = 1, max_count = 3, consume_on_use = true, sprite = "health_kit", desc = "+100 HP",
  on_use = function() api.heal(100) end }
register_item{ name = "Conductor Hat", type = 102, category = 1, max_count = 1, consume_on_use = false, sprite = "conductor_hat", desc = "+50 move speed",
  on_use = function() api.add_move_speed(50) end }
register_item{ name = "Armor Plate", type = 103, category = 1, max_count = 5, consume_on_use = true, sprite = "armor_plate", desc = "+1 Plate",
